...
public class ImageView extends AppCompatImageView {
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        ...
        } else if (attr == R.styleable.ImageView_bga_iv_circle) {
            mCircle = typedArray.getBoolean(attr, mCircle);
        } else if (attr == R.styleable.ImageView_bga_iv_cornerRadius) {
            mCornerRadius = typedArray.getDimensionPixelSize(attr, mCornerRadius);
        } else if (attr == R.styleable.ImageView_bga_iv_square) {
            mSquare = typedArray.getBoolean(attr, mSquare);
        } else if (attr == R.styleable.ImageView_bga_iv_borderWidth) {
            mBorderWidth = typedArray.getDimensionPixelSize(attr, mBorderWidth);
        } else if (attr == R.styleable.ImageView_bga_iv_borderColor) {
